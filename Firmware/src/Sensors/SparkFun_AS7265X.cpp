...
void AS7265X::update(SensorStructs::Spectrometer_t &spectrometerData)
{
  ...
  spectrometerData.c = getCalibratedC();
  spectrometerData.d = getCalibratedD();
  spectrometerData.e = getCalibratedE();
  spectrometerData.f = getCalibratedF();
  spectrometerData.g = getCalibratedG();
  spectrometerData.h = getCalibratedH();
  spectrometerData.i = getCalibratedI();
  spectrometerData.j = getCalibratedJ();
  spectrometerData.k = getCalibratedK();
  spectrometerData.l = getCalibratedL();
  spectrometerData.r = getCalibratedR();
  spectrometerData.s = getCalibratedS();
  spectrometerData.t = getCalibratedT();
  spectrometerData.u = getCalibratedU();
