...
Types::CoreTypes::State_ptr_t Flight::update()
{
    ...
    ApogeeInfo apogeeinfo =
        _system.apogeedetect.checkApogee(-_system.estimator.getData().position(2),
                                         -_system.estimator.getData().velocity(2), millis());
...
//         if ( (altitudeHistory.at(2) < altitudeHistory.at(1)) && (altitudeHistory.at(1) <
//         altitudeHistory.at(0)) && abs(altitudeHistory.at(2) - altitudeHistory.at(0)) > 2){
//             return true;
//         }
//     }
