...
namespace TimingConfig
{
    ...
    namespace Scheduler
    {
        ...
        constexpr uint32_t ESTIMATOR_UPDATE_RATE_HZ = 150;
    ...
    namespace EKF
    {
        ...
        constexpr uint32_t RTK_CORRECTION_RATE_HZ = 20; // CHAD forwards RTK packets at 20 Hz
        ...
        constexpr uint32_t RTK_CORRECTION_MAX_AGE_US = 150000UL; // tolerate up to 150ms delay
        constexpr uint32_t DELAYED_MEASUREMENT_HISTORY_US = 200000UL; //200ms
